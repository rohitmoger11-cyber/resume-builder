...
<footer class="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to-white mt-40">
    <div class="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
        <a href="#">
        <img src="/logo.svg" alt="logo" class="h-11 width-auto" />
            
        </a>
        <div>
            <p class="text-slate-800 font-semibold">Product</p>
            <ul class="mt-2 space-y-2">
                <li><a href="/" class="hover:text-green-600 transition">Home</a></li>
                <li><a href="/" class="hover:text-green-600 transition">Support</a></li>
                <li><a href="/" class="hover:text-green-600 transition">Pricing</a></li>
                <li><a href="/" class="hover:text-green-600 transition">Affiliate</a></li>
            </ul>
        </div>
        <div>
            <p class="text-slate-800 font-semibold">Resources</p>
            <ul class="mt-2 space-y-2">
                <li><a href="/" class="hover:text-green-600 transition">Company</a></li>
                <li><a href="/" class="hover:text-green-600 transition">Blogs</a></li>
                <li><a href="/" class="hover:text-green-600 transition">Community</a></li>
                <li><a href="/" class="hover:text-green-600 transition">Careers<span class="text-xs text-white bg-green-600 rounded-md ml-2 px-2 py-1">We’re hiring!</span></a></li>
                <li><a href="/" class="hover:text-green-600 transition">About</a></li>
            </ul>
        </div>
        <div>
            <p class="text-slate-100 font-semibold">Legal</p>
            <ul class="mt-2 space-y-2">
                <li><a href="/" class="hover:text-green-600 transition">Privacy</a></li>
                <li><a href="/" class="hover:text-green-600 transition">Terms</a></li>
            </ul>
        </div>
    </div>
    <div class="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
        ...
        <p class="mt-3 text-center">© 2026 Resume Builder</p>
    </div>
</footer>
<style>{`
