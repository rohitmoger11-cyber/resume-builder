...
const Testimonial = () => {
  ...
  return (
    <>
    <div id = "testimonial" className="flex flex-col items-center my-10 scoll-mt-12">
    <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-6 py-1.5">
        <BookUserIcon width={14} className="size-4.5 stroke-green-600" />
            <span>Testimonial</span>
        </div>
        <Title title="Don't just take our words" discription="Hear what our users have to say about their experience with our resume builder." />
        </div>
