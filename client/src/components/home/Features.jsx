...
const Features = () => {
  ...
  return (
     <div id = "features" className="flex flex-col items-center my-10 scoll-mt-12">
        <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-6 py-1.5">
        <Zap width={14} />
            <span>simple process</span>
        </div>
        <Title title='Build Your Resume' discription='Our streamlined process makes it easy to create a professional resume in minutes.' />
